...
class TestIngredientGetters:
    @pytest.mark.parametrize("ingredient_type, expected_name, expected_price", ingredient_test_cases)
    def test_type_getter(self, ingredient_type, expected_name, expected_price):
        ingredient = Ingredient(ingredient_type, expected_name, expected_price)
        assert ingredient.get_type() == ingredient_type

    @pytest.mark.parametrize("ingredient_type, expected_name, expected_price", ingredient_test_cases)
    def test_name_getter(self, ingredient_type, expected_name, expected_price):
        ingredient = Ingredient(ingredient_type, expected_name, expected_price)
        assert ingredient.get_name() == expected_name

    @pytest.mark.parametrize("ingredient_type, expected_name, expected_price", ingredient_test_cases)
    def test_price_getter(self, ingredient_type, expected_name, expected_price):
        ingredient = Ingredient(ingredient_type, expected_name, expected_price)
